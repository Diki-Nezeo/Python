...
# Fungsi mencari ruangan menggunakan Divide and Conquer
...
def add_schedule():
    ...
    for day in available_days:
        for time in available_times:
            ...
            if available_rooms:
                selected_room = find_room_dnc({room: test_rooms[room] for room in available_rooms}, mahasiswa)
...
# UI
root = tk.Tk()
root.title("Penjadwalan Ujian - Divide and Conquer")
